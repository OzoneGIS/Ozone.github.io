...
const stories = [
  {
    ...
    footer: (<UncontrolledButtonDropdown group={false}>
      <DropdownToggle caret="caret" className="btn-round" color="info">
        <i className="now-ui-icons design_bullet-list-67"/>{" "}
      </DropdownToggle>
      <DropdownMenu right="right">
        <DropdownItem header="header">Header</DropdownItem>
...
const dataTable = {
  headerRow: [
    "Name", "Position", "Office", "Age", "Actions"
  ],
  footerRow: [
    "Name", "Position", "Office", "Age", "Actions"
  ],
    ...
    'features': [
      {
        ...
        "geometry": {
          "type": "Point",
          "coordinates": [-120.426346, 37.365484]
        },
        "properties": {
          "title": "Innovate to Grow",
          "description": "Free Food 11am-2pm!"
        }
      }
    ]
  }
