...
import {dashboardCOB1ElectricityChart, dashboardCOB1WaterUsageChart, dashboardCOB1GasChart} from "variables/charts.jsx";


class DashboardCOB1 extends React.Component {

  render() {
    return (<div>
      <PanelHeader size="lg" content={<Line
        data = {
          dashboardCOB1ElectricityChart.data
        }
        options = {
          dashboardCOB1ElectricityChart.options
        }
        />}/>
        ...
        <Row>
            ...
            <Card className="card-chart">
              ...
              <CardBody>
                <div className="chart-area">
                  <Line data={dashboardCOB1WaterUsageChart.data} options={dashboardCOB1WaterUsageChart.options}/>
                </div>
              </CardBody>
              <CardFooter>
                <Stats>
          ...
          <Col xs={12} md={6}>
            <Card className="card-chart">
              ...
              <CardBody>
                <div className="chart-area">
                  <Line data={dashboardCOB1GasChart.data} options={dashboardCOB1GasChart.options}/>
                </div>
              </CardBody>
              <CardFooter>
                <Stats>
